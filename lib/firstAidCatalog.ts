...
export const DEFAULT_FIRST_AID_CATALOG: FirstAidCatalogItem[] = [
  ...
  {
    id: "roller-bandages",
    name: "Conforming roller bandages",
    section: "Bandages",
  },
  ...
  {
    id: "butterfly-closures",
    name: "Butterfly wound closures",
    section: "Wound care",
  },
  {
    id: "antibacterial-ointment",
  ...
  {
    id: "aloe-gel",
    name: "Aloe gel (sunburn treatment)",
  ...
  {
    id: "waste-bags",
    name: "Resealable clinical waste bags",
    section: "Hygiene",
  },
  {
    id: "incident-log",
    name: "Notepad incident log",
  ...
  {
    id: "antihistamines",
    name: "Antihistamines (children and adults)",
    section: "Medications",
  },
  ...
  {
    id: "pain-relief",
    name: "Pain relievers (children and adults)",
    section: "Medications",
  },
