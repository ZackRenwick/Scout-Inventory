...
import FeedbackPendingBadge from "../../islands/FeedbackPendingBadge.tsx";
    ...
    try {
      if (action === "create") {
        ...
        if (!allowedRoles.includes(role)) {
          throw new Error("You cannot create a user with that role.");
        }
      ...
      if (action === "change-password") {
        ...
        return ctx.render({
          ...
          latestBackup,
          message:
            `Password updated for "${username}". Their active sessions have been invalidated.`,
        });
      }
      ...
      <div>
        <div class="mb-4">
          <p class="text-gray-600 dark:text-gray-400">
            Manage access, operations, and data lifecycle from one place.
          </p>
        </div>
                ...
                >
                  {assignableRoles.map((roleOption) => (
                    <option value={roleOption}>
                      ...
                      {USER_ROLE_META[roleOption].description}
                    </option>
                  ))}
                </select>
              </div>
        ...
        <div class="mb-4">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">
            Day-to-day actions for stock, alerts, reports, and feedback.
          </p>
        </div>
        ...
        {isAdmin && (
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Manually trigger alert emails. Requires{" "}
        ...
        {isAdmin && (
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Create an on-demand JSON snapshot of inventory data in R2. Weekly
              backups can also run automatically when
              <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded text-xs ml-1">
                ENABLE_INVENTORY_BACKUP_CRON
              </code>
              is enabled.
            </p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Walk the store, physically count each item, and apply corrections.
            Items are ordered by location so you can move through the store
            systematically. A discrepancy report is shown before any changes are
            applied.
          </p>
          <a
        ...
        {isAdmin && (
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Quick links for common admin workflows.
            </p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Export the full inventory as a CSV file. Opens directly in Excel,
            LibreOffice, or Google Sheets. All categories and fields are
            included.
          </p>
          <div class="flex flex-wrap gap-3">
            <a
          ...
          {isAdmin && (
            <p class="text-xs text-gray-400 dark:text-gray-500 mt-2">
              Inventory JSON and camp templates JSON can both be re-uploaded
              from the import section below.
            </p>
          )}
        </div>
        ...
        {isAdmin && (
          <div class="mb-4">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Backup, import, and repair tooling for data operations.
            </p>
          </div>
        )}
        ...
        {isAdmin && (
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
            ...
            <details>
              <summary class="cursor-pointer text-sm font-medium text-gray-700 dark:text-gray-300 py-2">
                Open import tools
              </summary>
              <div class="pt-3">
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">
                  Import multiple inventory items at once by uploading a{" "}
                  <strong>.json</strong>{" "}
                  file. All items are validated before any are saved — if any
                  row has an error, the whole import is rejected.
                </p>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                  Maximum 500 items per upload. Remove the{" "}
                  <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded text-xs">
                    "_comment"
                  </code>{" "}
                ...
                <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
                  <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-1">
                    Camp Templates Import
                  </h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">
                    Upload templates exported from{" "}
                    <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded text-xs">
                      Download Camp Templates JSON
                    </code>. All templates are validated before anything is
                    saved.
                  </p>
                  <a
        ...
        {isAdmin && (
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-8">
            ...
            <details>
              ...
              <div class="pt-3">
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                  Rebuilds all KV secondary indexes and precomputed stats from
                  the primary item data. Only needed after a manual data
                  migration or if stats appear incorrect.
                </p>
        ...
        {isAdmin && (
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-red-200 dark:border-red-900 p-6 mb-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Permanently deletes all inventory items and resets the necker
              count and computed stats to zero. Loans, camp plans, meals, user
              accounts, and the activity log are not affected.
            </p>
            ...
            <details>
              ...
              <div class="pt-3">
                ...
                <ul class="text-sm text-gray-500 dark:text-gray-400 list-disc list-inside mb-4 space-y-1">
                  <li>
                    Orphaned secondary index entries (pointing to deleted items)
                  </li>
