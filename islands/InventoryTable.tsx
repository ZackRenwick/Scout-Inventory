...
export default function InventoryTable(
  ...
  const spaceFilter = useSignal<"all" | "camp-store" | "scout-post-loft">(
    "all",
  );
                  ...
                  <div class="flex items-start justify-between px-4 pt-4 pb-2">
                    ...
                    <div class="flex items-center gap-1.5 shrink-0 ml-2">
                      ...
                      {"condition" in item && !needsRepair && (() => {
                        ...
                        return (
                          <span
                            class={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${condColor}`}
                          >
                            {condLabel}
                          </span>
                        );
